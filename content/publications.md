...
<div class="publication-item">
    <div class="publication-title">サケのオスはより大きなメスを好む：バイオロギング手法を使ったサケの産卵行動解析</div>
    <div class="publication-authors"><strong><u>牧口祐也</u></strong>（分担執筆）</div>
    <div class="publication-journal">竹垣毅・坂井陽一 編『魚たちの行動と生態―その謎を解き明かす面白さ』上巻、第7章、恒星社厚生閣</div>
    <div class="publication-meta">
        <span class="publication-year publication-year-visible"><i class="fas fa-calendar"></i> 2026年10月1日刊行予定</span>
        <span class="publication-doi"><i class="fas fa-link"></i> <a href="/news/2026-09-18-fish-behavior-book/">執筆のお知らせ</a></span>
    </div>
</div>
